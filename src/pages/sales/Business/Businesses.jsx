...
const Businesses = () => {
    ...
    const [projectList, setProjectList] = useState([
        {
            ...
            orderAmount: '78,600,000', Invoice: '', status: '작성중', order: 'FMCS 그룹', salesDepartment: 'FMCS 그룹', salesAgent: '이수형 부장',
            pm: '손영훈 부장', year: '2022', endDate: '2022/12/30', margin: '20%'
        },
        {
            name: '드림클래스 2.0 후속과제 개발', code: 'P002', startDate: '2023/01/05', currency: '원화', vendor: '미라콤', contactPerson: '손영훈 부장',
            orderAmount: '194,881,000', Invoice: '', status: '수주진행중', order: 'PS팀', salesDepartment: 'WEB 그룹', salesAgent: '이수형 부장',
            pm: '유승현 부장', year: '2023', endDate: '2023/6/12', margin: '20%'
        },
    ]);
    ...
    const handleSearchData = async () => { //검색
        // ...
    };
                ...
                <tbody >
                            ...
                            <tr >
                                ...
                                <td >
                                    <input
                                            type="text"
                                            value={secondTableData.salesAgent}
                                            onChange={(e) => handleInputChange('salesAgent', e.target.value)}
                                    />
                                </td>
                                <th >PM</th>
                                <td >
                            ...
                            <tr >
                                ...
                                <td >
                                    <input
                                            type="text"
                                            value={secondTableData.startDate}
                                ...
                                <td >
                                    <input
                                            type="text"
                                            value={secondTableData.endtDate}
                                            onChange={(e) => handleInputChange('endtDate', e.target.value)}
                                    />
                                </td>
                                <th >상태</th>
                                <td >
                                    {getStateElement("working")}
                                </td>
                            </tr>
                            <tr >
                                <th >
