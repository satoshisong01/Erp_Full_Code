...
/** 영업관리-견적관리 */
function Quotation() {
    const { currentPageName, innerPageName, setPrevInnerPageName, setInnerPageName, setCurrentPageName, setNameOfButton, inquiryConditions, unitPriceListRenew } = useContext(PageContext);
                        ...
                        <ul>
                            <div className="form-buttons mg-b-20" style={{ maxWidth: 1400 }}>
                                <PopupButtonReport
                                    ...
                                    data={{ label: "견적품의서", type: "document", ...condition }}
                                />
