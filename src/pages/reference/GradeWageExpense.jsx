...
function GradeWageExpense() {
    ...
    const columns = [
        ...
        { header: "기준명", col: "gupDesc", cellWidth: "89", type: "input" },
        { header: "임원", col: "gupPrice1", cellWidth: "89", type: "input" },
        { header: "부장", col: "gupPrice9", cellWidth: "89", type: "input" },
        { header: "차장", col: "gupPrice10", cellWidth: "89", type: "input" },
        { header: "과장", col: "gupPrice11", cellWidth: "89", type: "input" },
        { header: "대리", col: "gupPrice12", cellWidth: "89", type: "input" },
        { header: "주임", col: "gupPrice13", cellWidth: "89", type: "input" },
        { header: "사원", col: "gupPrice14", cellWidth: "89", type: "input" },
