...
/** 시스템관리-메뉴관리-메뉴정보관리 */
const MenuInfo = () => {
	const [treeNode, setTreeNode] = useState({ title: "", isParent: false, key: "", });
	...
	const handleResize = (event, direction, ref, delta) => {
		...
		console.log(" containerWidth: ", containerWidth , " resizableWidth: ", resizableWidth, ", newLeftWidth: ", newLeftWidth);
