...
import "./OutsourcingCostDetails.css";
import {
    DataGrid,
    GridColumn,
    NumberBox,
...
import DateSearch from "../../common/tableHeader/DateSearch";
import DatesBox from "../../common/tableHeader/DatesBox";
...
export default class OutsourcingCostDetails extends React.Component {
    constructor(props) {
        super(props);
