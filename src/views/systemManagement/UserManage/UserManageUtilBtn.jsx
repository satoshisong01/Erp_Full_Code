...
import UserManageModalPagePost from "./UserManageModalPagePost";

export default function UserManageUtilBtn({
                 initialData,
                 refresh,
                 changeInt,
                 selectedData,
                 ...
                 const [UserManage, setUserManage] = useState(1); //키 값 넘버자동 1씩추가
      ...
      `);
                ...
                >
                    ...
                    추가
                     ...
                     {postModalOpen && (
                       <UserManageModalPagePost
                         onClose={() => {
                           setPostModalOpen(false);
                         }}
                         refresh={refresh}
                         countUserManage={UserManage}
                         urlName={urlName}
                         headers={headers}
                       />
                     )}
