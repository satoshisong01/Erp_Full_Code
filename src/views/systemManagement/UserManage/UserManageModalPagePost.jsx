...
export default function UserManageModalPagePost({
                 onClose,
                 refresh,
                 countUserManage,
                 urlName,
                 ...
                 const [UserManage, setUserManage] = useState(countUserManage);
                 ...
                 const onAdd = async (e) => {
                   ...
                   const newUserManage = countUserManage + 1;
                   setUserManage(newUserManage);
