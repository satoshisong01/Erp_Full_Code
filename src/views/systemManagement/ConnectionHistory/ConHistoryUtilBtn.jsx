...
import ConHistoryModalPagePost from "./ConHistoryModalPagePost";

export default function ConHistoryUtilBtn({
                 initialData,
                 refresh,
                 changeInt,
                 selectedData,
                 ...
                 const [ConHistory, setConHistory] = useState(1); //키 값 넘버자동 1씩추가
      ...
      `);
                ...
                >
                    ...
                    추가
                     ...
                     {postModalOpen && (
                       <ConHistoryModalPagePost
                         onClose={() => {
                           setPostModalOpen(false);
                         }}
                         refresh={refresh}
                         countConHistory={ConHistory}
                         urlName={urlName}
                         headers={headers}
                       />
                     )}
