...
export default function ConHistoryModalPagePost({
                 onClose,
                 refresh,
                 countConHistory,
                 urlName,
                 ...
                 const [ConHistory, setConHistory] = useState(countConHistory);
                 ...
                 const onAdd = async (e) => {
                   ...
                   const newConHistory = countConHistory + 1;
                   setConHistory(newConHistory);

                   const newData = {
                     ...data,
                     ConHistory: newConHistory,
                   };
