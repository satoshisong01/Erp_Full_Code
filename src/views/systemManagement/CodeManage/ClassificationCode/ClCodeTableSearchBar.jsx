      ...
      <div className="searchMain">
        ...
        >
          <div className="topMenuBtn">
            <button className="btn btn-primary refreshIcon" onClick={refresh}>
          ...
          <div className="box">
            <div className="box1">
              <label htmlFor="searchKeyword" className="box_search">
                검색어
              </label>
              <input
                type="text"
            ...
            <div className="box2">
              <label htmlFor="searchCondition" className="box_search">
                검색조건
              </label>
              {urlName === "clCode" && (
                <select
