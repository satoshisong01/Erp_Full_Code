export const columns = {
    ...
    orderPlanMgmt: {
        ...
        purchase: [
            ...
            { header: "품명", col: "pdiNm", cellWidth: "150", type: "productInfo", require: true, textAlign: "left" },
            { header: "품목그룹명", col: "pgNm", cellWidth: "150", textAlign: "left" },
            { header: "모델명", col: "pdiNum", cellWidth: "150", textAlign: "left" },
            { header: "판매사", col: "pdiSeller_name", cellWidth: "120", textAlign: "left" },
            { header: "제조사", col: "pdiMenufut_name", cellWidth: "120", textAlign: "left" },
            { header: "규격", col: "pdiStnd", cellWidth: "180", textAlign: "left" },
