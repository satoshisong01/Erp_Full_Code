export const columns = {
    ...
    orderPlanMgmt: {
        ...
        labor: [
            ...
            { header: "연월", col: "pmpMonth", cellWidth: "130", type: "datePicker" },
            { header: "M/M계", col: "total", cellWidth: "80" },
            { header: "인건비계", col: "totalPrice", cellWidth: "100", type: "number" },
            { header: "부장", col: "pmpmmPositionCode9", cellWidth: "80", type: "input" },
            { header: "차장", col: "pmpmmPositionCode10", cellWidth: "80", type: "input" },
            { header: "과장", col: "pmpmmPositionCode11", cellWidth: "80", type: "input" },
            { header: "대리", col: "pmpmmPositionCode12", cellWidth: "80", type: "input" },
            { header: "주임", col: "pmpmmPositionCode13", cellWidth: "80", type: "input" },
            { header: "사원", col: "pmpmmPositionCode14", cellWidth: "80", type: "input" },
            { header: "비고", col: "pmpDesc", cellWidth: "549", type: "input" },
        ],
        laborCal: [
            //인건비합계
            { header: "합계", col: "total", cellWidth: "184" },
            { header: "임원", col: "pmpmmPositionCode1Total", cellWidth: "170" },
        ...
        purchase: [
            ...
            { header: "제조사", col: "pdiMenufut", cellWidth: "150" },
            ...
            { header: "공급단가", col: "unitPrice", cellWidth: "100", type: "input" },
    ...
    laborCostMgmt: {
        ...
        budgetView: [
            ...
            { header: "M/M", col: "totalMm", cellWidth: "80", type: "datePicker" },
            { header: "금액", col: "totalPrice", cellWidth: "174", type: "datePicker" },
            // { header: "임원", col: "pmpmmPositionCode1", type: "input", notView: true },
            { header: "부장", col: "price9", cellWidth: "170", type: "input" },
            { header: "차장", col: "price10", cellWidth: "170", type: "input" },
            { header: "과장", col: "price11", cellWidth: "170", type: "input" },
            { header: "대리", col: "price12", cellWidth: "170", type: "input" },
            { header: "주임", col: "price13", cellWidth: "170", type: "input" },
            { header: "사원", col: "price14", cellWidth: "170", type: "input" },
        ],
        run: [
            {
                header: "품목그룹명",
    ...
    expenseMgmt: {
        ...
        cal: [
            ...
            { header: "교통비", col: "pjbgTypeCode1", cellWidth: "180" },
            { header: "숙박비", col: "pjbgTypeCode2", cellWidth: "180" },
            { header: "일비/파견비", col: "pjbgTypeCode3", cellWidth: "180" },
            { header: "식비", col: "pjbgTypeCode4", cellWidth: "180" },
            { header: "자재/소모품외", col: "pjbgTypeCode5", cellWidth: "180" },
            { header: "기타", col: "pjbgTypeCode20", cellWidth: "179" },
        ],
        monthCal: [
