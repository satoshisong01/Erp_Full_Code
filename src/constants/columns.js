export const columns = {
    ...
    orderPlanMgmt: {
        ...
        purchase: [
            ...
            { header: "모델명", col: "pdiNum", cellWidth: "150", notView: true },
            { header: "판매사", col: "pdiSeller", cellWidth: "100" },
            { header: "통화", col: "byCurrcy", cellWidth: "50", notView: true },
            ...
            { header: "소비자 금액", col: "consumerAmount", cellWidth: "100" },
            { header: "단가", col: "unitPrice", cellWidth: "100", type: "input" },
            { header: "금액", col: "planAmount", cellWidth: "100" },
